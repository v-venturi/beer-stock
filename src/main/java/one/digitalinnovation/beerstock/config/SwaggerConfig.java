...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Vitório Venturi";
    private static final String CONTACT_GITHUB = "https://gtihub.com/v-venturi";
    private static final String CONTACT_EMAIL = "vitorioventuri@gmail.com";
